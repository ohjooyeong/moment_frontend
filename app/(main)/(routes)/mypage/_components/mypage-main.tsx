    ...
    <div className="w-full">
      ...
      <div className="bg-white p-6 rounded-3xl shadow space-y-6">
        <div className="flex justify-between items-center cursor-pointer">
          <h3 className="text-sm font-semibold">개인정보 수정</h3>
        ...
        <div className="flex justify-between items-center cursor-pointer">
          <h3 className="text-sm font-semibold">모멘트 문의하기</h3>
          <ChevronRight size={20} className="text-gray-400" />
        </div>
        <div className="flex justify-between items-center cursor-pointer">
          <h3 className="text-sm font-semibold">리뷰 쓰러가기</h3>
          <ChevronRight size={20} className="text-gray-400" />
        </div>
        <div className="flex justify-between items-center cursor-pointer">
          <h3 className="text-sm font-semibold">로그아웃</h3>
          <ChevronRight size={20} className="text-gray-400" />
        </div>
      </div>
    </div>
