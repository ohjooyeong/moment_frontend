  ...
  return (
    <div className="flex-col justify-around w-full">
      <div className="flex flex-col justify-center items-center mb-[24px]">
        <div className="relative flex items-center justify-center w-full rounded-2xl font-semibold text-lg text-black h-[56px]">
          <ArrowLeftIcon
            width={24}
            height={24}
      ...
      <div className="flex flex-col justify-center gap-5 mb-[60px]">
        <div className="flex flex-col w-full">
          ...
          <div className="flex relative w-full">
            <Input
              className="pl-[50px] relative w-full rounded-2xl h-[60px] font-medium text-[16px]/[24px] text-customBlack-1 border-customGray-3 focus-visible:ring-transparent focus-visible:border-primary placeholder:text-customGray-3"
        ...
        <div className="flex justify-between">
          <div className="flex items-center space-x-2 ml-2 ">
            <Checkbox
              id="id-save-check"
              className="data-[state=checked]:text-white data-[state=checked]:border-primary w-[22px] h-[22px] border-customGray-3"
            />
            <label
              htmlFor="id-save-check"
              className="text-customGray-1 select-none cursor-pointer leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-[14px]/[22px]"
            >
              이메일 저장
            </label>
          </div>
      ...
      <Button className="relative bg-primary w-full rounded-2xl h-[60px] font-semibold text-lg text-white mb-[47px]">
        로그인
      </Button>
      <div className="flex items-center justify-between gap-[22px]">
        <Button
          variant={"outline"}
          className="flex items-center justify-center bg-white w-full rounded-2xl h-[60px] font-semibold text-lg text-white mb-[47px] border-customGray-2"
        >
          <Image
            width={34}
            height={34}
        ...
        <Button
          variant={"outline"}
          className="relative bg-white w-full rounded-2xl h-[60px] font-semibold text-lg text-white mb-[47px] border-customGray-2"
        >
          <Image
            width={28}
            height={28}
